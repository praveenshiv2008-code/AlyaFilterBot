...
# Keep-Alive URL
KEEP_ALIVE_URL = environ.get("KEEP_ALIVE_URL", "https://nutritious-evey-mnbots-c8b6564d.koyeb.app/")  # <-- Add this line
#hyper link
...
PICS = (environ.get('PICS', 'https://files.catbox.moe/t3c8bc.jpg https://files.catbox.moe/xh6fdc.jpg https://files.catbox.moe/9tqcsy.jpg https://files.catbox.moe/sla8rd.jpg')).split()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1892771262').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002490892111 -1002097504396 -1003157977363 -1003034885508').split()]
...
LOG_STR += ("Private movie search messages in PM will be redirected to the configured group link.\n")
LOG_STR += ("User search messages will be deleted after handling.\n" if DELETE_USER_SEARCH_MESSAGE else "User search messages will be kept after handling.\n")
